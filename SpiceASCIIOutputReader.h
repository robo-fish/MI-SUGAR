...
/* This is for converting normal SPICE output, generated by the
.PRINT commands, into MI-SUGAR's internal ResultsTable representation. */
@interface SpiceASCIIOutputReader : NSObject
{
}
